...
# p value is 0.7859, we do not reject
# H0: model2 is true model
# i.e. accepted
...
summary(back)
## from both individual testing, two way anova, and backward stepwise testing
## we have finally found the final model, model2
## glm(survival ~ AGE + TBSA + factor(INH_INJ), family = "binomial", data = data)
...
# Though p value is .11 i.e. 11% significance
# We can consider this model, because we can't innore the status of burning
# We can say that if the sample size increases
# it will move towards significance at 5%